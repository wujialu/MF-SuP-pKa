from MF_SuP_pka.build_dataset import built_data_and_save_for_pka
import argparse
...
if __name__ == '__main__':
    ...
    output_g_attentivefp_bin = '../data/MF_SuP_pka_graph_data/' + args.dataset + '_graph.bin'
    output_csv = '../data/MF_SuP_pka_graph_data/' + args.dataset + '_group.csv'
